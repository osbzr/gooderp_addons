odoo.define('gooderp_pos.DB', function (require) {
"use strict";
...
var PosDB = core.Class.extend({
    ...
    _partner_search_string: function(partner){
        ...
        if(partner.main_address){
            str += '|' + partner.main_address;
        }
        // if(partner.phone){ //TODO:暂时去除
        //     str += '|' + partner.phone.split(' ').join('');
        // }
        if(partner.main_mobile){
            str += '|' + partner.main_mobile.split(' ').join('');
        }
        // if(partner.email){
        //     str += '|' + partner.email;
        // }
    ...
    add_partners: function(partners){
        ...
        if (updated_count) {
            ...
            for (var id in this.partner_by_id) {
                ...
                // partner.address = (partner.street || '') +', '+  //TODO:逻辑变更
                //                   (partner.zip || '')    +' '+
                //                   (partner.city || '')   +', '+
