    ...
    local.HomePage = instance.Widget.extend({
        start: function() {
            ...
            self.$el.append("<div id='main' class='main'>\
                                <div class='class='section m-t-lg m-b-lg top_div'>\
                                    <div class='container'>\
                                            <div class='row'>\
                            ...
                            <div class='main_div'><div class='row'>\
                                <div class='col-sm-6 col-sm-offset-3 feature-bg text-center'>\
            ...
            new instance.web.Model("home.page").call("get_action_url").then(function(result){
                ...
                for(var i=0;i< 8;i++){
                    if (self.result_quick[i]!==undefined){
                        ...
                        var left_html_str = $(" <div class='col-xs-12 col-md-6'><li  class='text-muted oe_p oe_quick_link_"+i+"' id='"+i+"'>" +
                            " <p class='bg-success'>"+self.result_quick[i][0]+"</p></li></div>");
