    ...
    def partner_statements_without_goods(self):
        ...
        for s in self:
            ...
            if self.env.context.get('default_customer'):  # 客户
                if self.env.get('sell.order') != None:
                    view = self.env.ref('sell.customer_statements_report_tree')
                else:
                    view = self.env.ref('money.customer_statements_report_simple_tree')
                ...
                if self.env.get('buy.order') != None:
                    ...
                    view = self.env.ref('money.supplier_statements_report_simple_tree')
