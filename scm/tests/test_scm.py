...
class test_crm(TransactionCase):
    def setUp(self):
        ...
        self.wh_move_line_keyboard_1 = self.env.ref('warehouse.wh_move_line_13') # wh.move.line  keyboard
        self.wh_move_line_keyboard_2 = self.wh_move_line_keyboard_1.copy()
        self.wh_move_in_2 = self.wh_move_in_1.copy()

        self.sell_order_1 = self.env.ref('sell.sell_order_1') # sell.order  mouse
    ...
    def test_stock_request_done(self):
        ...
        self.env.ref('buy.buy_return_order_line_1').order_id.partner_id = self.env.ref('core.zt').id
