odoo.define('good_shop.cart', function (require) {
    "use strict";
...
odoo.define('good_shop.website_sale_category', function (require) {
    "use strict";
...
odoo.define('good_shop.website_sale', function (require) {
    "use strict";
