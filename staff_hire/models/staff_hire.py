...
class RecruitmentSource(models.Model):
    ...
    job_id = fields.Many2one('staff.job', "Job ID")
    ...
    #             },
    #         }
    #         source.alias_id = self.with_context(alias_model_name='hr.applicant', alias_parent_model_name='staff.job').env['mail.alias'].create(vals)
...
class RecruitmentStage(models.Model):
    ...
    job_id = fields.Many2one('staff.job', string='Job Specific',
                             ondelete='cascade',
...
class Applicant(models.Model):
    ...
    categ_ids = fields.Many2many('hr.applicant.category', string=u"标签")
    ...
    job_id = fields.Many2one('staff.job', u"申请职位")
    ...
    salary_proposed = fields.Float(u"建议薪资", help="Salary Proposed by the Organisation")
    salary_expected = fields.Float(u"期望薪资", help="Salary Expected by Applicant")
    availability = fields.Date(u"开始工作日期", help=u"申请人能够开始工作的日期")
    partner_name = fields.Char("Applicant's Name")
    partner_phone = fields.Char(u"电话", size=32)
    partner_mobile = fields.Char(u"手机", size=32)
    type_id = fields.Many2one('hr.recruitment.degree', u"学位")
    ...
    emp_id = fields.Many2one('staff', string=u"员工", track_visibility="onchange", help="Employee linked to the applicant.")
    ...
    def get_empty_list_help(self, help):
        return super(Applicant, self.with_context(empty_list_help_model='staff.job',
    ...
    #     aliases = self.env['staff.job'].message_get_reply_to(applicants.mapped('job_id').ids, default=default)
    ...
    def create_employee_from_applicant(self):
        ...
        for applicant in self:
            ...
            if applicant.job_id and (applicant.partner_name or contact_name):
                ...
                employee = self.env['staff'].create({'name': applicant.partner_name or contact_name,
